...
class Schema(Resource):
    def __init__(self, schema_filepath, topic_name):
    ...
    @Resource.log_notify
    def create(self):
        url = join(self._base_url, 'subjects', self._topic_name + '-value', 'versions')
        payload = "{ \"schema\": \"" \
    ...
    @Resource.log_notify
    def delete(self):
        url = join(self._base_url, 'subjects', self.topic + '-value')

...
def sync():
    command = """rsync -avL --exclude '.env.override/*' --exclude 'ui/node_modules/*' --progress -e "ssh -i ~/.ssh/mark-chen-IAM-key-pair.pem" --log-file="/Users/a67/rsync.log" /Users/a67/Project/insight/heart_watch/ ubuntu@{}:~/heart_watch/"""
    for dns in [
        'ec2-3-216-241-119.compute-1.amazonaws.com',
